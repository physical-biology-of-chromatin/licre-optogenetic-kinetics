...
logfilename = 'exploreParams_licre_fit_progress.log'
...
eps=10
# For LiCre:
# RUmaxh = 0.033*32*38*1 ~ 58
# RUmaxf = 0.033*11*38*2 ~ 40
# alph ~ 2.2
p_inf=[1,  54,36,0.08,-3,-3,-4,-4] #alp,RUmaxh,RUmaxf,kt,k1,km1,k2,km2
p_sup=[2.5,62,44,1.1,  2, 2, 2, 0]
...
#
##########################################
outfileroot = "exploreParams_licre_fit_results_"
